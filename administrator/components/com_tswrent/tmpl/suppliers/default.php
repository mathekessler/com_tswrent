                            ...
                            <?php foreach ($this->items as $i => $item) :
                                ...
                                ?>
                                 <tr class="row<?php echo $i % 2; ?>">
                                    ...
                                    <td class="text-center">
                                        <?php echo HTMLHelper::_('jgrid.published', $item->published, $i, 'suppliers.', $canChange); ?>
                                    </td>
                                    ...
                                    <td class="text-center btns d-none d-md-table-cell itemnumber">
                                        <a class="btn <?php echo ($item->count_published > 0) ? 'btn-success' : 'btn-secondary'; ?>" href="<?php echo Route::_('index.php?option=com_tswrent&view=brands&filter[supplier_id]=' . (int) $item->id . '&filter[published]=1'); ?>"
                                    ...
                                    <td class="text-center btns d-none d-md-table-cell itemnumber">
                                        <a class="btn <?php echo ($item->count_unpublished > 0) ? 'btn-danger' : 'btn-secondary'; ?>" href="<?php echo Route::_('index.php?option=com_tswrent&view=brands&filter[supplier_id]=' . (int) $item->id . '&filter[published]=0'); ?>"
                                    ...
                                    <td class="text-center btns d-none d-md-table-cell itemnumber">
                                        <a class="btn <?php echo ($item->count_archived > 0) ? 'btn-info' : 'btn-secondary'; ?>" href="<?php echo Route::_('index.php?option=com_tswrent&view=brands&filter[supplier_id]=' . (int) $item->id . '&filter[published]=2'); ?>"
                                    ...
                                    <td class="text-center btns d-none d-md-table-cell itemnumber">
                                        <a class="btn <?php echo ($item->count_trashed > 0) ? 'btn-dark' : 'btn-secondary'; ?>" href="<?php echo Route::_('index.php?option=com_tswrent&view=brands&filter[brand_id]=' . (int) $item->id . '&filter[published]=-2'); ?>"
