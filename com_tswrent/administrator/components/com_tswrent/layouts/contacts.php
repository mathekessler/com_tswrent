    ...
    <div class="row">
        <table class="table"> 
            <caption class="visually-hidden">
                <?php echo Text::_('COM_TSWRENT_CONTACTS_TABLE_CAPTION'); ?>,
            ...
            <tbody>
                <?php foreach ($contact as $i => $contact) :
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <th scope="row" >
                        <a href="<?php echo Route::_('index.php?option=com_tswrent&view=contact&id=' . (int) $contact->id); ?>" title="<?php echo Text::_('JACTION_EDIT'); ?> <?php echo $this->escape($contact->title); ?>">
                                    <?php echo $this->escape($contact->title); ?></a>
                        </td>
