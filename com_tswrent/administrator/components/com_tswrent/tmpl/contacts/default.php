...
?>
<form action="<?php echo Route::_('index.php?option=com_tswrent&view=contacts'); ?>" method="post" name="adminForm" id="adminForm">
	<div class="row">
		<div class="col-md-12">
						...
						<tbody>
							<?php foreach ($this->items as $i => $item) :
								...
								<tr class="row<?php echo $i % 2; ?>">
                                    ...
                                    <td class="text-center">
                                        <?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'contacts.', $canChange); ?>
                                    </td>
