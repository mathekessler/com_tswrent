...
?>
<form action="<?php echo Route::_('index.php?option=com_tswrent&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="supplier-form" class="form-validate">
