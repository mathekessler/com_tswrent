...
?>
<form action="<?php echo Route::_('index.php?option=com_tswrent&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="brand-form" aria-label="<?php echo Text::_('COM_TSWRENT_BRAND_' . ((int) $this->item->id === 0 ? 'NEW' : 'EDIT'), true); ?>"class="form-validate">
