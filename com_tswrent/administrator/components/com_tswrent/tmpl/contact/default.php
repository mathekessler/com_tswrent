...
?>
<form action="<?php echo Route::_('index.php?option=com_tswrent&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="contact-form" class="form-validate">	
				...
				<div class="col-md-12">
					<div id="j-main-container" class="j-main-container">
						<?php /** load Suppliers Layout **/
							...
							echo LayoutHelper::render('suppliers', $data_supplier, 'com_tswrent.layouts');  // Load the layout 
						?>
					</div>
				</div>
			</div>
				...
				<div class="col-md-12">
					<div id="j-main-container" class="j-main-container">
						<?php /** load Suppliers Layout **/
							...
							echo LayoutHelper::render('customers', $data_customer, 'com_tswrent.layouts');  // Load the layout 
						?>
					</div>
				</div>
			</div>
