...
$link      = 'index.php?option=com_tswrent&view=suppliers&layout=modal&tmpl=component&' . Session::getFormToken() . '=1&function=' . $function;
		...
		<?php else : ?>
			<table class="table table-sm">
				...
				<?php foreach ($this->items as $i => $item) : ?>
                    ...
                    <?php
                        $link     = 'index.php?Supplierid=' . $item->id;
