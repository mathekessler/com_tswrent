...
/**
 * Supports a modal supplier picker.
 *
 * @since  1.6
 */
class SuppliersField extends ModalSelectField
{
    /**
     * The form field type.
     *
    ...
    public function setup(\SimpleXMLElement $element, $value, $group = null): bool
    {
		...
		$modalTitle = Text::_('COM_TSWRENT_SUPPLIERS');
		...
		//$this->hint = $this->hint ?: Text::sprintf('COM_STWRENT_CHOSES', Text::_('COM_TSWRENT_SUPPLIER'));
        ...
        if ($value) {
            try {
                ...
                $query = $db->getQuery(true)
                    ...
                    ->from($db->quoteName('#__tswrent_suppliers'))
