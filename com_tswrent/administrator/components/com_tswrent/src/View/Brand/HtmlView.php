...
namespace TSWEB\Component\Tswrent\Administrator\View\Brand;
...
use TSWEB\Component\Tswrent\Administrator\Model\BrandModel;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
        ...
        $this->canDo    = ContentHelper::getActions('com_tswrent', 'brand'  , $this->item->id);
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(
			$isNew ? Text::_('COM_TSWRENT_MANAGER_BRAND_NEW') : Text::_('COM_TSWRENT_MANAGER_BRAND_EDIT'),
