...
namespace TSWEB\Component\Tswrent\Administrator\View\Contacts;
...
use TSWEB\Component\Tswrent\Administrator\Model\ContactsModel;
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar(): void
    {
        ...
        ToolbarHelper::title(Text::_('COM_TSWRENT_MANAGER_CONTACTS'), 'bookmark contacts');
            ...
            if ($canDo->get('core.edit.state')) {
                ...
                if ($this->state->get('filter.published') != -1) {
                    if ($this->state->get('filter.published') != 2) {
                        ...
                        $childBar->publish('publish')->task('contacts.publish')->listCheck(true);
                    }
                }
